...
import { FeaturedBales } from '@app/components/FeaturedBales'
...
export default function Home() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-orange-50 to-indigo-100 section-padding">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Quality Clothing Bales for
                <span className="text-orange-600"> Retailers</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/shop" className="btn-secondary bg-orange-600 inline-flex items-center justify-center">
                  Browse Bales
                ...
                >
                  <MessageCircle className="mr-2 w-5 h-5 bg-green-100 rounded-full" />
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-max">
          ...
          <div className="text-center mt-12">
            <Link href="/shop" className="bg-orange-700 text-white px-6 py-3 rounded hover:bg-orange-800 transition-colors">
              View All Bales
            </Link>
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="section-padding bg-orange-900">
        <div className="container-max text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="bg-white text-orange-600 hover:bg-gray-100 font-semibold py-3 px-6 rounded-lg transition-colors inline-flex items-center justify-center"
            >
              <Phone className="mr-2 w-5 h-5" />
              Call Now: +254 757 270 511
            </a>
            <a
              href="https://wa.me/254757270511?text=Hi! I'd like to learn more about your clothing bales"
